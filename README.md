...
dotnet ef migrations add InitialCreateForUrlShortener -p API_NetworkTools/API_NetworkTools.csproj -s API_NetworkTools/API_NetworkTools.csproj
...
```json
{
  ...
  "data": {
    "shortUrl": "[https://api.solidstate.network/s/xxxxxx](https://api.solidstate.network/s/xxxxxx)", // xxxxxxx ist der generierte Kurzcode
    "longUrl": "[https://www.google.com/search?q=sehr+lange+url+mit+vielen+parametern](https://www.google.com/search?q=sehr+lange+url+mit+vielen+parametern)"
  },
  "errorMessage": null,
  "rawOutput": null
}
